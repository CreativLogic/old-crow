...
let _searchQuery = '';
let _viewMode = (typeof localStorage !== 'undefined' && localStorage.getItem('raven-notes-view')) || 'list'; // 'list' or 'grid'
...
const REMINDER_FIRED_KEY = 'raven-notes-reminder-fired';
...
const REMINDER_GLOWED_KEY = 'raven-notes-reminder-glowed';
...
const REMINDER_PENDING_HIGHLIGHT_KEY = 'raven-notes-reminder-pending-highlight';
const REMINDER_ACTIVE_HIGHLIGHT_KEY = 'raven-notes-reminder-active-highlight';
...
const REMINDER_DISMISSED_AT_KEY = 'raven-notes-reminder-dismissed-at';
const NOTES_FIRST_OPEN_HINT_KEY = 'raven-notes-first-open-hint-v1';
...
const _CUSTOM_GRADIENT = 'conic-gradient(from 0deg, #00A8FF, #d19a66, #e5c07b, #98c379, #61afef, #c678dd, #00A8FF)';
...
export function openPanel() {
  ...
  if (viewBtn) {
    ...
    viewBtn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('raven-notes-view', _viewMode); } catch {}
      pane.classList.toggle('notes-view-grid', _viewMode === 'grid');
      _setViewLabel();
      requestAnimationFrame(() => _applyMasonry(document.querySelector('#notes-pane .notes-pane-body')));
    });
...
const _DRAFT_PREFIX = 'raven-note-draft-';
