...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'raven-model-expanded',
  MODEL_ENDPOINTS: 'raven-model-endpoints',
  MODEL_SELECTED: 'raven-selected-model',
  SORT_ORDER: 'raven-sessions-sort',
  CHAT_SEARCH_SCOPE: 'raven-search-scope',
  INCOGNITO: 'raven-incognito',
  RAG_ACTIVE: 'raven-rag-active',
  MCP_ACTIVE: 'raven-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'raven-density'
};
