...
function initMermaid() {
  if (!window.mermaid || window.__ravenMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__ravenMermaidReady = true;
}
window.ravenInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'raven-thinking-expanded';
