...
def test_serve_runner_preserves_command_exit_code():
    ...
    assert "RAVEN_CMD_EXIT=$?" in script
    assert 'echo "=== Process exited with code $RAVEN_CMD_EXIT ==="' in script
