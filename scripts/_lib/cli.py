"""scripts/_lib/cli.py — shared scaffolding for the `raven-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("raven-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/raven-foo`
...
VERSION = "0.1.0"  # bumped centrally; every raven-* CLI reports this
