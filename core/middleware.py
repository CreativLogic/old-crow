...
INTERNAL_TOOL_TOKEN = os.environ.get("RAVEN_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-RAVEN-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-RAVEN-Internal-Token), or
